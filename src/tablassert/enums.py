...
class EdgeCategories(str, Enum):
    ...
    GENE_TO_PHENOTYPIC_FEATURE = "GeneToPhenotypicFeatureAssociation"
    GENE_TO_GENE = "GeneToGeneAssociation"
    GENE_TO_GENE_FAMILY = "GeneToGeneFamilyAssociation"
    GENE_TO_PATHWAY = "GeneToPathwayAssociation"
    GENE_TO_EXPRESSION_SITE = "GeneToExpressionSiteAssociation"
    CHEMICAL_GENE_INTERACTION = "ChemicalGeneInteractionAssociation"
    CHEMICAL_TO_CHEMICAL = "ChemicalEntityToChemicalEntityAssociation"
    CHEMICAL_TO_PATHWAY = "ChemicalEntityToPathwayAssociation"
    CHEMICAL_TO_BIOLOGICAL_PROCESS = "ChemicalEntityToBiologicalProcessAssociation"
    GENOTYPE_TO_DISEASE = "GenotypeToDiseaseAssociation"
    GENOTYPE_TO_PHENOTYPIC_FEATURE = "GenotypeToPhenotypicFeatureAssociation"
    GENOTYPE_TO_GENE = "GenotypeToGeneAssociation"
    MATERIAL_SAMPLE_TO_DISEASE_OR_PHENOTYPIC_FEATURE = "MaterialSampleToDiseaseOrPhenotypicFeatureAssociation"
    CELL_LINE_TO_DISEASE_OR_PHENOTYPIC_FEATURE = "CellLineToDiseaseOrPhenotypicFeatureAssociation"
    CASE_TO_DISEASE = "CaseToDiseaseAssociation"
    CASE_TO_PHENOTYPIC_FEATURE = "CaseToPhenotypicFeatureAssociation"
    CASE_TO_GENE = "CaseToGeneAssociation"
    CASE_TO_VARIANT = "CaseToVariantAssociation"
    VARIANT_TO_DISEASE = "VariantToDiseaseAssociation"
    VARIANT_TO_PHENOTYPIC_FEATURE = "VariantToPhenotypicFeatureAssociation"
    VARIANT_TO_GENE = "VariantToGeneAssociation"
    DISEASE_TO_DISEASE = "DiseaseToDiseaseAssociation"
    DISEASE_TO_PHENOTYPIC_FEATURE = "DiseaseToPhenotypicFeatureAssociation"
    ORGANISM_TAXON_TO_ORGANISM_TAXON = "OrganismTaxonToOrganismTaxonAssociation"
