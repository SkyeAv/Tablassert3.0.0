...
class IsAttributeOutput(BaseIOSchema):
    ...
    sample_size_portion: THIS IS AN OPTIONAL FIELD... <See Important Instructions>
    ...
    p_value_portion: THIS IS AN OPTIONAL FIELD... <See Important Instructions>
    ...
    fdr_portion: THIS IS AN OPTIONAL FIELD... <See Important Instructions>
    ...
    strength_portion: THIS IS AN OPTIONAL FIELD... <See Important Instructions>
    ...
    statistic_portion: THIS IS AN OPTIONAL FIELD... <See Important Instructions>

    notes: THIS IS AN OPTIONAL FIELD... An optional unique free-text attribute capturing anything that cannot be encoded in the fields above or attributes in general but is relevant to understanding the finding(s) at hand
