...
# ? resolve_many Threads Explicit QC Provider
def test_resolve_many_threads_qc_provider(monkeypatch: Any, tmp_path: Path) -> None:
    calls: list[tuple[Any, ...]] = []
    ...
    lib.resolve_many("subject", ["BRCA1"], tmp_path, qc=True, qc_provider="cpu")
