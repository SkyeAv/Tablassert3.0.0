...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `resource_id` | String | Yes | Infores CURIE of this entry; mirrored into `id` on output. Must start with `infores:`, and must be unique within the template. |
